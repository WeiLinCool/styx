    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <div className={`flex flex-col items-center gap-3 sm:flex-row sm:justify-center transition-all duration-700 delay-500 ${heroLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          ...
          <Link href={content.secondaryCta.href} className="flex items-center gap-2 rounded-full border-2 border-[#1d1d1f] px-8 py-3.5 text-sm font-semibold text-[#1d1d1f] transition-all hover:bg-[#1d1d1f] hover:text-white hover:scale-[1.02] active:scale-[0.98]">
      ...
      <div className="mx-auto max-w-5xl px-5">
        <Reveal>
          <div className="mb-16 text-center">
            <p className="mb-3 text-2xl font-bold text-[#1d1d1f]">{content.eyebrow}</p>
            ...
            <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              {content.process.map((step, i) => {
                ...
                <div key={step.step} className="flex items-center gap-3">
                  ...
                  {i < content.process.length - 1 && <ArrowRight size={14} className="hidden shrink-0 text-[#444444] sm:block" />}
                </div>
                );
              })}
            </div>
        ...
        <Reveal>
          <div className="text-center">
            ...
            <div className="flex justify-center gap-3">
              <Link href={content.primaryCta.href} className="rounded-full bg-[#1d1d1f] px-6 py-2.5 text-sm font-semibold text-white shadow-md transition-all hover:bg-[#333] hover:shadow-lg">
                {content.primaryCta.label}
              </Link>
              <Link href={content.secondaryCta.href} className="flex items-center gap-2 rounded-full border-2 border-[#1d1d1f] px-6 py-2.5 text-sm font-semibold text-[#1d1d1f] transition-all hover:bg-[#1d1d1f] hover:text-white">
                {content.secondaryCta.label}
              </Link>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-5xl px-5">
        <Reveal>
          <div className="mb-12 text-center">
            <p className="mb-3 text-sm font-medium text-[#444444]">{content.eyebrow}</p>
            <h2 className="text-3xl font-bold tracking-tight text-[#1d1d1f]">{content.headline}</h2>
          </div>
        </Reveal>
              ...
              {content.tools.map((f) => (
                <Reveal key={f.label}>
                  <Link href={f.href} className="group flex items-start gap-5 rounded-2xl border border-black/8 bg-white/70 p-6 shadow-sm backdrop-blur-lg transition-all hover:border-black/12 hover:shadow-md">
                    ...
                    <div>
                      <h3 className="mb-1 text-base font-semibold text-[#1d1d1f]">{f.label}</h3>
