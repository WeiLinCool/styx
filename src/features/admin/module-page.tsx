...
const metricToneClassName: Record<AdminMetricTone, string> = {
  ...
  success: 'border-emerald-500/20 bg-emerald-500/12',
  warning: 'border-amber-500/20 bg-amber-500/12',
  danger: 'border-red-500/20 bg-red-500/12',
  info: 'border-blue-500/20 bg-blue-500/12',
};
