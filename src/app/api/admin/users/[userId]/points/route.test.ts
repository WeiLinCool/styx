...
test('parseAdminUserPointsRequest trims reason and keeps signed non-zero amount', async () => {
...
test('parseAdminUserPointsRequest rejects zero amount and empty reason', async () => {
  await assert.rejects(
    () =>
